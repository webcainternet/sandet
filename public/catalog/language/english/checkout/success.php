...
$_['text_customer']        = '<p>O seu pedido foi cadastrado em nossa loja.</p><p>Você pode ver o histórico dos seus pedidos através de sua <a href="%s">conta</a>, acessando o menu <a href="%s">histórico de pedidos</a>.</p><p>Entre em contato com nosso <a href="/index.php?route=information/contact">atendimento</a> caso tenha dúvidas.</p><p>Obrigado por comprar em nossa loja.</p>';
$_['text_guest']           = '<p>O seu pedido foi cadastrado em nossa loja.</p><p>Entre em contato com nosso <a href="/index.php?route=information/contact">atendimento</a> caso tenha dúvidas.</p><p>Obrigado por comprar em nossa loja.</p>';