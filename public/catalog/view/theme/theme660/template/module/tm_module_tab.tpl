			...
			<div class="box-carousel">
				...
				<div class="product-thumb transition <?php if ($product['options']) echo 'options';?>">
						...
						<div id="quickview_featured_<?php echo $tf . $module ?>" class="quickview-style">
							<div>
								...
								<div class="right col-sm-8">
									...
									<?php } ?>
									<button class="product-btn-add" data-toggle="tooltip" title="<?php echo $button_cart; ?>" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"> <i class="fa fa-shopping-cart"></i> <span><?php echo $button_cart; ?></span> </button>
					...
					<div class="cart-button">
						<button class="product-btn-add" type="button" <?php if (count($product['options']) >= 4) { ?> onclick="cart.add('<?php echo $product['product_id']; ?>');" <?php } else { ?> onclick="ajaxAdd($(this),<?php echo $product['product_id'] ?>);" <?php } ?>>
