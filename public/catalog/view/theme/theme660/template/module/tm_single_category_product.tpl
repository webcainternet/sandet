			...
			<div class="box-content">
				<div role="tabpanel" class="module_tab" id="single-category<?php echo $module; ?>">
					...
					<ul class="nav nav-tabs" role="tablist" id="module-single-tabs-<?php echo $module; ?>">
						...
						<li>
							<a href="#tab-single-featured-<?php echo $module; ?>" role="tab" data-toggle="tab">
						...
						<li>
							<a href="#tab-single-latest-<?php echo $module; ?>" role="tab" data-toggle="tab">
						...
						<li>
							<a href="#tab-single-specials-<?php echo $module; ?>" role="tab" data-toggle="tab">
						...
						<li>
							<a href="#tab-single-bestsellers-<?php echo $module; ?>" role="tab" data-toggle="tab">
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane" id="tab-single-featured-<?php echo $module; ?>">
							<div class="box clearfix">
								<div class="box-carousel">
									<?php $tf = 5000;
									foreach ($featured_products as $product) { $tf++ ?>
						...
						<div role="tabpanel" class="tab-pane" id="tab-single-latest-<?php echo $module; ?>">
							<div class="box clearfix">
								<div class="box-carousel">
									<?php $tl = 6000;
									foreach ($latest_products as $product) { $tl++ ?>
									<div class="product-thumb transition <?php if ($product['options']) echo 'options'; ?>">
										<?php if ($product['options']) { ?>
										<!-- Product options -->
										<div class="product-option-wrap">
						...
						<div role="tabpanel" class="tab-pane" id="tab-single-specials-<?php echo $module; ?>">
							<div class="box clearfix">
								<div class="box-carousel">
									<?php $ts = 7000;
									foreach ($special_products as $product) { $ts++ ?>
									<div class="product-thumb transition <?php if ($product['options']) echo 'options'; ?>">
										<?php if ($product['options']) { ?>
										<!-- Product options -->
										<div class="product-option-wrap">
										...
										<?php } ?>
										<div class="quick_info">
											<div id="quickview_specials_<?php echo $ts . $module ?>" class="quickview-style">
												<div>
													<div class="left col-sm-4">
														<div class="quickview_image image">
															<a href="<?php echo $product['href']; ?>"><img alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" src="<?php echo $product['thumb']; ?>"/></a>
										...
										<div class="image">
											...
											<a class="quickview" data-rel="details" href="#quickview_specials_<?php echo $ts . $module ?>">
												<?php echo $text_quick; ?>
											</a>
										</div>
										<div class="caption">
						...
						<div role="tabpanel" class="tab-pane" id="tab-single-bestsellers-<?php echo $module; ?>">
							<div class="box clearfix">
								<div class="box-carousel">
									<?php $tb = 8000;
									foreach ($bestseller_products as $product) { $tb++ ?>
									<div class="product-thumb transition <?php if ($product['options']) echo 'options'; ?>">
										<?php if ($product['options']) { ?>
										<!-- Product options -->
										<div class="product-option-wrap">
