                            ...
                            <div class="product-options form-horizontal">
                                <div class="options">
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                        ...
                                        <?php } ?>
                                    <?php } ?>
                                    <button class="btn btn-primary" type="button" onclick="cart.addPopup($(this),'<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span><?php echo $button_cart; ?></span></span>
                                    </button>
                                </div>
                            </div>
                        </div>
